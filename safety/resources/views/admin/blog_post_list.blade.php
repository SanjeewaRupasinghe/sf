...
@if(session()->has('msg'))<div class="alert alert-success"> {{session('msg')}}</div>@endif
    <h1 class="h3 mb-4 text-gray-800">Manage Blog Posts <a href="{{route('blogPost.create')}}" class="btn btn-info float-right">New Post</a></h1>
            ...
            <div class="row">
                <div class="col-sm-12" >
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('blogPost.edit', $result->id )}}" class=""><i class="fa fa-edit"></i></a>
                            <form method="post" action="{{route('blogPost.destroy',$result->id)}}" class="form-inline d-inline">
                                @csrf
