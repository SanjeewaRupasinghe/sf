...
@section('content')
    ...
    <h1 class="h3 mb-4 text-gray-800">New Blog Category <a href="{{route('blogCategory.index')}}" class="btn btn-info float-right">Back</a></h1>
    <div class="card shadow mb-4">
        <div class="card-body">
        <div class="row">
            <div class="col-sm-12" >
                <form action="{{route('blogCategory.store')}}" method="post"  name="fname" enctype="multipart/form-data" role="form" id="formm">
                    @csrf
                    <div class="row">
