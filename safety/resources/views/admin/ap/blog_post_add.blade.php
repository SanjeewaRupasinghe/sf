...
@section('content')
    ...
    <h1 class="h3 mb-4 text-gray-800">New Appraisal Blog Post <a href="{{route('apBlogPost.index')}}" class="btn btn-info float-right">Back</a></h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="row">
            ...
            <div class="col-sm-12" >
                ...
                <form action="{{route('apBlogPost.store')}}" method="post"  name="fname" enctype="multipart/form-data" role="form" id="formm">
