...
@section('content')
    ...
    <h1 class="h3 mb-4 text-gray-800">New Appraisal Service 
        <a href="{{route('apCourse.index')}}" class="btn btn-info float-right">Back</a>
    </h1>
    <div class="card shadow mb-4">
        <div class="card-body">
        <div class="row">
            <div class="col-sm-12" >
                <form action="{{route('apCourse.store')}}" method="post"  name="fname" enctype="multipart/form-data" role="form" id="formm">
                    @csrf
                    <div class="row">
                            ...
                            <div class="tree-container">                                    
                                ...
                                <div class="tree-item active  {{ ($cat->children)?'has-children':''   }}">
                                    ...
                                    @if(count($cat->children))
                                        @include('admin.ad.courseChild',['children' => $cat->children])
                                    @endif                                
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <div class="col-sm-5 form-group">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12">
                                    <label for="form-phone">Extras <i>(each one separated by comma ',')</i></label>
                                    <textarea rows="4" id="extras" name="extras" class="form-control" >{{old('extras')}}</textarea>
                                </div>
                                <div class="form-group col-sm-12">
                                    <label for="form-phone">Extras Arabic<i>(each one separated by comma ',')</i></label>
                                    <textarea rows="4" id="ar_extras" name="ar_extras" class="form-control" >{{old('ar_extras')}}</textarea>
                                </div>
                                <div class="col-sm-12 form-group">
