...
@if(session()->has('msg'))<div class="alert alert-success"> {{session('msg')}}</div>@endif
    <h1 class="h3 mb-4 text-gray-800">Appraisal Category 
        <a href="{{route('apCategory.create')}}" class="btn btn-info float-right">New Category</a></h1>
            ...
            <div class="row">
                <div class="col-sm-12" >
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('apCategory.edit', $result->id )}}" class=""><i class="fa fa-edit"></i></a>
                            <form method="post" action="{{route('apCategory.destroy',$result->id)}}" class="form-inline d-inline">
                                @csrf
