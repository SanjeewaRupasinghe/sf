...
@section('content')
<h1 class="h3 mb-4 text-gray-800">Edit Blog Post <a href="{{route('blogPost.index')}}" class="btn btn-info float-right">Back</a></h1>
   <div class="card shadow mb-4">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-12" >
                    <form action="{{route('blogPost.update',$blogPost->id)}}" method="post"  name="fname" enctype="multipart/form-data" role="form" id="formm">
                        @csrf
