<div>
    <div>
        ...
        <div class="section-content">
            ...
            <div style="margin-bottom: 15px">
                ...
                <div class="radio-group">
                    <div class="radio-option">
                        <span
                            class="radio-button {{ isset($appraisalData['se_sigEvents']) && $appraisalData['se_sigEvents'] == 'I have not been named in any significant events in the last year.' ? 'radio-checked' : '' }}">o</span>
                        <span class="radio-button"></span><strong>I have not</strong> been named in any significant
                        events in the last year.
                    </div>
                    <div class="radio-option">
                        <span
                            class="radio-button {{ isset($appraisalData['se_sigEvents']) && $appraisalData['se_sigEvents'] == 'I have been named in one or more significant events in the last year.' ? 'radio-checked' : '' }}">o</span>
            ...
            <!-- ELSE -->
            @if (isset($appraisalData['se_sigEvents']))
                @if ($appraisalData['se_sigEvents'] == 'I have been named in one or more significant events in the last year.')
                 <p>
