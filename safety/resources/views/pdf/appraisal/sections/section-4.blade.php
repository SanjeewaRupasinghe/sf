        ...
        <div class="section-content">
            ...
            <div class="form-row">
                ...
                <table class="form-table">
                    ...
                    <tbody>
                        @if (isset($appraisalData['ws_roles']) && is_array($appraisalData['ws_roles']))
                            @foreach ($appraisalData['ws_roles'] as $r)
                                <tr>
                                    <td>{{ $r->role ?? '' }}</td>
                                    <td>{{ $r->work ?? '' }}</td>
                                    <td>{{ $r->organization ?? '' }}</td>
                                    <td>{{ $r->yearCommenced ?? '' }}</td>
                                </tr>
                            @endforeach
                        @else
                            <tr>
            ...
            <div class="form-row">
                ...
                <div class="form-input form-input-large">
                    {{ $appraisalData['ws_envisageNextYear'] ?? '' }}
                </div>
            </div>
