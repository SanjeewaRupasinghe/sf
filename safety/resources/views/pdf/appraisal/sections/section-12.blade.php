            ...
            <div style="margin-bottom: 15px">
                ...
                <div class="radio-group">
                    <div class="radio-option">
                        ...
                        <span
                            class="radio-button {{ isset($appraisalData['ac_includeDocuments']) && $appraisalData['ac_includeDocuments'] == 'on' ? 'radio-checked' : '' }}">o</span>
