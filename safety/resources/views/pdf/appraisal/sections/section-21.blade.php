<div>
    <div>
        <div class="section-header">
            Section 21 of 21
            <br>Completion - save, lockdown and print
        </div>
        ...
        <div class="section-content">
            ...
            <div style="border: 1px solid #00000071">
            ...
            <div class="instruction-text">
                Mandatory fields can be found in Section 3 Personal details, Section 17 Appraisal checklist and Section
                20
                Appraisal outputs.
                <br>
                <br>
                ...
                > Section 13 Probity and health statements have been ticked, or if not, that explanation has been given
                as
                to why not.
                <br>
                <br>

                Additionally, you should check that in Section 9 Significant events and Section 11 Review of complaints
                and
 ...
 <p>
            ...
            <div style="border: 1px solid #00000071">Print</div>
