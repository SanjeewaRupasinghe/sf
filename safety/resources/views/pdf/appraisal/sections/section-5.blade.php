        ...
        <div class="section-content">
            ...
            <div style="margin-bottom: 15px">
                ...
                <div class="form-input">
                    {{ $appraisalData['an_lastAppraisalDate'] ?? '' }}
                </div>
            </div>
            ...
            <div style="margin-bottom: 15px">
                ...
                <div class="radio-group">
                    <div class="radio-option">
                        <span
                            class="radio-button {{ isset($appraisalData['an_hasChanged']) && $appraisalData['an_hasChanged'] == 'yes' ? 'radio-checked' : '' }}">o</span>
                        <span class="radio-button"></span> Yes
                    </div>
                    <div class="radio-option">
                        <span
                            class="radio-button {{ isset($appraisalData['an_hasChanged']) && $appraisalData['an_hasChanged'] == 'no' ? 'radio-checked' : '' }}">o</span>
                        <span class="radio-button radio-checked"></span> No
                    </div>
                </div>
            </div>

            @if (isset($appraisalData['an_hasChanged']))
                @if ($appraisalData['an_hasChanged'] == 'yes')
                    <div style="margin-bottom: 15px">
                        <span style="font-weight: bold">Name of appraiser at last appraisal, if different:</span>
                        <div class="form-input">
                            {{ $appraisalData['an_appraiserName'] ?? '' }}
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom: 15px">
                        <span style="font-weight: bold">Name of responsible officer at last appraisal, if
                            different:</span>
                        <div class="form-input">
                            {{ $appraisalData['an_responsibleOfficer'] ?? '' }}
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom: 15px">
                        ...
                        <div class="form-input">
                            {{ $appraisalData['an_designatedBody'] ?? '' }}
                        </div>
                    </div>
                @endif
            @endif
