<div>
    <div>
        ...
        <div class="section-content">
            ...
            <div style="margin-bottom: 15px">
                ...
                <div class="radio-group">
                    <div class="radio-option">
                        <span
                            class="radio-button {{ isset($appraisalData['fb_colleagueFeedback']) && $appraisalData['fb_colleagueFeedback'] == 'yes' ? 'radio-checked' : '' }}">o</span>
                        <span class="radio-button"></span>Yes
                    </div>
                    <div class="radio-option">
                        <span
                            class="radio-button {{ isset($appraisalData['fb_colleagueFeedback']) && $appraisalData['fb_colleagueFeedback'] == 'no' ? 'radio-checked' : '' }}">o</span>
            ...
            <!-- ELSE -->
            @if (isset($appraisalData['fb_colleagueFeedback']))
                @if ($appraisalData['fb_colleagueFeedback'] == 'no')
                    ...
                    <div class="form-input form-input-large">
                        {{ $appraisalData['fb_colleagueFeedbackDate'] ?? '' }}
                    </div>
                    <label class="form-label">
                    ...
                    <div class="form-input form-input-large">
                        {{ $appraisalData['fb_colleagueRevalidation'] ?? '' }}
                    </div>
                @endif
            @endif
            <!-- END ELSE -->
            ...
            <div style="margin-bottom: 15px">
                ...
                <div class="radio-group">
                    <div class="radio-option">
                        <span
                            class="radio-button {{ isset($appraisalData['fb_patientFeedback']) && $appraisalData['fb_patientFeedback'] == 'yes' ? 'radio-checked' : '' }}">o</span>
                        <span class="radio-button"></span>Yes
                    </div>
                    <div class="radio-option">
                        <span
                            class="radio-button {{ isset($appraisalData['fb_patientFeedback']) && $appraisalData['fb_patientFeedback'] == 'no' ? 'radio-checked' : '' }}">o</span>
                        <span class="radio-button radio-checked"></span>No
                    </div>
                </div>
            </div>
            ...
            <!-- ELSE -->
            @if (isset($appraisalData['fb_patientFeedback']))
                @if ($appraisalData['fb_patientFeedback'] == 'no')
                    <label class="form-label">
                        Please enter the date of your last
                        <br>
                        colleague feedback:
                    ...
                    <div class="form-input form-input-large">
                        {{ $appraisalData['fb_patientFeedbackDate'] ?? '' }}
                    </div>
                    <label class="form-label">
                        If your responsible officer does not already hold a copy of this colleague feedback exercise,
                        please
