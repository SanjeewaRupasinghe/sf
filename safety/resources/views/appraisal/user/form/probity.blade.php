...
@section('title', 'Probity and health statements')
...
@section('content')
    ...
    <form action="{{ route('appraisal.user.probity.submit') }}" method="POST">
        ...
        <div class="content-body">
            ...
            <div class="mb-4">
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" id="probityConfirm" name="probityConfirm"
                        @if ($_probityConfirm == 'on') checked @endif>
                ...
                <div id="probityDeclarationSection"
                    @if ($_probityDeclaration == 'something') style="display: block; @else style="display: none; @endif">
                    ...
                    <textarea class="form-control" name="gmcOrOther">{{ $_gmcOrOther }}</textarea>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" id="healthConfirm" name="healthConfirm"
                        @if ($_healthConfirm == 'on') checked @endif>
            ...
            <div class="mb-4">
                <textarea class="form-control" rows="8" name="comments">{{ $_comments }}</textarea>
            </div>
