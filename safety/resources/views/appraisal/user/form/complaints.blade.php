...
@section('content')
    ...
    <form action="{{ route('appraisal.user.complaints.submit') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="d-flex justify-content-between">
            <a class="btn btn-sm btn-primary" href="{{route('appraisal.user.feedback')}}">
                < Previous section</a>
                    ...
                    <a class="btn btn-sm btn-primary" href="{{route('appraisal.user.achievements')}}">Next section ></a>
        </div>
