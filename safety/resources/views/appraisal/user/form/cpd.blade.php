...
@section('title', 'Continuing professional development (CPD)')
                ...
                <div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="royalCollege" id="royalCollegeYes"
                            value="yes" @if ($_royalCollege == 'yes') checked @endif>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="royalCollege" id="royalCollegeNo"
                            value="no" @if ($_royalCollege == 'no') checked @endif>
                    ...
                    <div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="annualCertificate"
                                id="annualCertificateYes" value="yes" @if ($_annualCertificate == 'yes') checked @endif>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="annualCertificate" id="annualCertificateNo"
                                value="no" @if ($_annualCertificate == 'no') checked @endif>
                    ...
                    <div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="additionalCPD" id="additionalCPDYes"
                                value="yes" @if ($_additionalCPD == 'yes') checked @endif>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="additionalCPD" id="additionalCPDNo"
                                value="no" @if ($_additionalCPD == 'no') checked @endif>
                    ...
                    <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-select form-select-sm location-select"
                                                name="supportingInfo[]">
                                                <option>Please select...</option>
                                                <option @if ($_jobRoles[$i]->supportingInfo == 'Attached') selected @endif
                        ...
                        <tfoot>
                            <tr style="background-color: #f8f9fa;">
                                ...
                                <td><strong><span id="totalCredits">{{ $_creditT }}</span></strong></td>
                                <td colspan="3"></td>
                            </tr>
                        </tfoot>
                    </table>
