...
@section('title', 'Appraisal checklist')
...
@section('content')
    ...
    <form @if ($LOCKDOWN_STATUS) action="{{ route('appraisal.user.checklist.submit') }}" @endif method="POST">
        @csrf
        ...
        <div class="content-body">
                                            ...
                                            <tr>
                                                <td width="50">
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @if ($_what_this_checklist_is_for == 'on') checked @endif>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @if ($_previous_appraisal_record == 'on') checked @endif>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="form-check-input" name="scope_of_work"
                                                        id="scope_of_work" @if ($_scope_of_work == 'on') checked @endif>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="form-check-input" name="reflection"
                                                        id="reflection" @if ($_reflection == 'on') checked @endif>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="form-check-input" name="confidentiality"
                                                        id="confidentiality"
                                                        @if ($_confidentiality == 'on') checked @endif>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td width="50">
                                                    <input type="checkbox" class="form-check-input" name="personal_details"
                                                        id="personal_details"
                                                        @if ($_personal_details == 'on') checked @endif>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="form-check-input" name="overall"
                                                        id="overall" @if ($_overall == 'on') checked @endif>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @if ($_review_of_last_year_pdp == 'on') checked @endif>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="form-check-input" name="cpd"
                                                        id="cpd" @if ($_cpd == 'on') checked @endif>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @if ($_quality_improvement_activities == 'on') checked @endif>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @if ($_significant_events == 'on') checked @endif>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @if ($_feedback_from_colleagues == 'on') checked @endif>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @if ($_feedback_from_patients == 'on') checked @endif>
                                                </td>
                                                <td>
                                                    <span class="text-primary">Feedback
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @if ($_complaints_and_compliments == 'on') checked @endif>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @if ($_achievements_challenges_aspirations == 'on') checked @endif>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @if ($_probity_declaration == 'on') checked @endif>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @if ($_health_declaration == 'on') checked @endif>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @if ($_additional_information == 'on') checked @endif>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @if ($_review_of_gmc_good_medical_practice == 'on') checked @endif>
                                                </td>
                                                <td>
                                                    <span class="text-primary">Review of
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="form-check-input" name="new_pdp_ideas"
                                                        id="new_pdp_ideas"
                                                        @if ($_new_pdp_ideas == 'on') checked @endif>
                                                </td>
                                                <td>
                        ...
                        <div class="border p-3 mb-3">
                            ...
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="confirm_agreement" required
                                    id="confirm_agreement" @if ($_confirm_agreement == 'on') checked @endif>
            ...
            <div class="d-flex justify-content-between">
                <a class="btn btn-sm btn-primary" href="{{ route('appraisal.user.gmc-domains') }}">
                    < Previous section</a>
                        @if ($LOCKDOWN_STATUS)
                            <button type="submit" class="btn btn-sm btn-success">Save Form</button>
                        @endif
                        <a class="btn btn-sm btn-primary" href="{{ route('appraisal.user.development-plan') }}">Next
                            section ></a>
            </div>
