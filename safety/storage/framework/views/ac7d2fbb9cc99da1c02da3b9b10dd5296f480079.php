                    ...
                    <div>
                        <div class="radio-group">
                            <div class="radio-option">
                                <span
                                    class="radio-button <?php echo e(isset($appraisalData['ad_specInfo']) && $appraisalData['ad_specInfo'] == 'yes' ? 'radio-checked' : ''); ?>">o</span>
                                <span class="radio-button"></span> Yes
                            </div>
                            <div class="radio-option">
                                <span
                                    class="radio-button <?php echo e(isset($appraisalData['ad_specInfo']) && $appraisalData['ad_specInfo'] == 'no' ? 'radio-checked' : ''); ?>">o</span>
                                <span class="radio-button radio-checked"></span> No
                            </div>
                        </div>

                        <!-- IF -->
                        <?php if(isset($appraisalData['ad_specInfo'])): ?>
                            <?php if($appraisalData['ad_specInfo'] == 'yes'): ?>
                                ...
                                <div class="form-input form-input-large">
                                    <?php echo e($appraisalData['ad_appropriate'] ?? ''); ?>
                        ...
                        <div class="form-input form-input-large">
                            <?php echo e($appraisalData['ad_comments'] ?? ''); ?>
...
<?php /**PATH C:\xampp\htdocs\Projects\sf_live\safety\resources\views/pdf/appraisal/sections/section-14.blade.php ENDPATH**/ ?>