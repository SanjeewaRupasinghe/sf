<div>
    <div>
        ...
        <div class="section-content">
            ...
            <div style="margin-bottom: 15px">
                ...
                <div class="radio-group">
                    <div class="radio-option">
                        <span
                            class="radio-button <?php echo e(isset($appraisalData['com_complaintsStatus']) && $appraisalData['com_complaintsStatus'] == 'I have not I have not been named in any complaints in the last year.' ? 'radio-checked' : ''); ?>">o</span>
                        <span class="radio-button"></span> <strong>I have not</strong> I have not been named in any complaints in the last year.
                    </div>
                    <div class="radio-option">
                        <span
                            class="radio-button <?php echo e(isset($appraisalData['com_complaintsStatus']) && $appraisalData['com_complaintsStatus'] == 'I have been named in one or more significant events in the last year.' ? 'radio-checked' : ''); ?>">o</span>
            ...
            <!-- ELSE -->
            <?php if(isset($appraisalData['com_complaintsStatus'])): ?>
                <?php if($appraisalData['com_complaintsStatus'] == 'I have been named in one or more significant events in the last year.'): ?>
                    ...
                    <div class="form-input form-input-large">
                        <?php echo e($appraisalData['com_feedback'] ?? ''); ?>
            ...
            <div class="form-input form-input-large">
                <?php echo e($appraisalData['com_comments'] ?? ''); ?>
...
<?php /**PATH C:\xampp\htdocs\Projects\sf_live\safety\resources\views/pdf/appraisal/sections/section-11.blade.php ENDPATH**/ ?>