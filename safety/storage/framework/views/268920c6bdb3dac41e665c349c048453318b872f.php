...
<li class="nav-item">
    <a class="nav-link" href="<?php echo e(route('admin.appraisal.user')); ?>">
        <i class="fas fa-fw fa-cog"></i>
        <span>Appraisal Users</span></a>
</li>
<?php /**PATH C:\xampp\htdocs\Projects\sf_live\safety\resources\views/admin/menu.blade.php ENDPATH**/ ?>