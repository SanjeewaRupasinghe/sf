<?php $__env->startSection('title', 'The agreed personal development plan'); ?>
                        ...
                        <tr>
                            <td>
                                <select class="form-select" name="role[]">
                                    ...
                                    <option value="Cross Role" <?php if($_roles[$i]->role == 'Cross Role'): ?> selected <?php endif; ?>>Cross Role
                                    </option>
                                </select>
                            </td>
                            <td>
...
<?php echo $__env->make('appraisal.user.form.layout.appraisal-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Projects\sf_live\safety\resources\views/appraisal/user/form/personal-development-plan.blade.php ENDPATH**/ ?>