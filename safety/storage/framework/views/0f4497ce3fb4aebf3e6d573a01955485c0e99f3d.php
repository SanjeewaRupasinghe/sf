<?php $__env->startSection('title', 'Personal development plans and their review'); ?>
        ...
        <div class="content-body">
                        ...
                        <?php if($_jobRolesCount > 0): ?>
                            <?php for($i = 0; $i < $_jobRolesCount; $i++): ?>
                                <tr>
                                    ...
                                    <td>
                                        <textarea class="form-control" rows="3" name="lastAppraisal[]"><?php echo e($_jobRoles[$i]->lastAppraisal); ?></textarea>
                                    </td>
                                    <td>
            ...
            <div class="mt-4">
                <label for="generalComments" class="form-label">If you would like to make any general comments to your
                    ...
                    please
                    do so here.</label>
                <textarea class="form-control bg-light" id="generalComments" rows="4" name="generalComments"><?php echo e($_generalComments); ?></textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea class="form-control" id="appraisersComments" name="appraisersComments" rows="5"><?php echo e($_appraisersComments); ?></textarea>
            </div>
...
<?php echo $__env->make('appraisal.user.form.layout.appraisal-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Projects\sf_live\safety\resources\views/appraisal/user/form/development-plans.blade.php ENDPATH**/ ?>