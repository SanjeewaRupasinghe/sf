<div>
    <div>
        ...
        <div class="section-content">
                        ...
                        <tr>
                            <td>
                                <div class="radio-option">
                                    <span
                                        class="radio-button <?php echo e(isset($appraisalData['ck_what_this_checklist_is_for']) && $appraisalData['ck_what_this_checklist_is_for'] == 'on' ? 'radio-checked' : ''); ?>">o</span>
                                    <span class="radio-button"></span>
                                </div>
                            </td>
                            <td>What this checklist is for – background</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
                                <div class="radio-option">
                                    <span
                                        class="radio-button <?php echo e(isset($appraisalData['ck_previous_appraisal_record']) && $appraisalData['ck_previous_appraisal_record'] == 'on' ? 'radio-checked' : ''); ?>">o</span>
                                    <span class="radio-button"></span>
                                </div>
                            </td>
                            <td>Previous
                                appraisal record – submitted</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
                                <div class="radio-option">
                                    <span
                                        class="radio-button <?php echo e(isset($appraisalData['ck_scope_of_work']) && $appraisalData['ck_scope_of_work'] == 'on' ? 'radio-checked' : ''); ?>">o</span>
                                    <span class="radio-button"></span>
                                </div>
                            </td>
                            <td>Scope of
                                work – completed, with reflection, including governance
                                arrangements and conflicts of interest</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
                                <div class="radio-option">
                                    <span
                                        class="radio-button <?php echo e(isset($appraisalData['ck_confidentiality']) && $appraisalData['ck_confidentiality'] == 'on' ? 'radio-checked' : ''); ?>">o</span>
                                    <span class="radio-button"></span>
                                </div>
                            </td>
                            <td>Reflection</span> – present
                                throughout submission</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
                                <div class="radio-option">
                                    <span
                                        class="radio-button <?php echo e(isset($appraisalData['ck_what_this_checklist_is_for']) && $appraisalData['ck_confidentiality'] == 'on' ? 'radio-checked' : ''); ?>">o</span>
                                    <span class="radio-button"></span>
                                </div>
                            </td>
                            <td>Confidentiality –
                                identifiable information removed/redacted</td>
                            <td></td>
                        </tr>
                    </tbody>
                    <thead>
                        <tr>
                            <th colspan="3">Supporting information</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td>
                                <div class="radio-option">
                                    <span
                                        class="radio-button <?php echo e(isset($appraisalData['ck_personal_details']) && $appraisalData['ck_personal_details'] == 'on' ? 'radio-checked' : ''); ?>">o</span>
                                    <span class="radio-button"></span>
                                </div>
                            </td>
                            <td>Personal
                                details – completed and up to date</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
                                <div class="radio-option">
                                    <span
                                        class="radio-button <?php echo e(isset($appraisalData['ck_overall']) && $appraisalData['ck_overall'] == 'on' ? 'radio-checked' : ''); ?>">o</span>
                                    <span class="radio-button"></span>
                                </div>
                            </td>
                            <td>Overall – supporting information matches my scope of work</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
                                <div class="radio-option">
                                    <span
                                        class="radio-button <?php echo e(isset($appraisalData['ck_review_of_last_year_pdp']) && $appraisalData['ck_review_of_last_year_pdp'] == 'on' ? 'radio-checked' : ''); ?>">o</span>
                                    <span class="radio-button"></span>
                                </div>
                            </td>
                            <td>Review of
                                last year's PDP – present</td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <div class="radio-option">
                                    <span
                                        class="radio-button <?php echo e(isset($appraisalData['ck_cpd']) && $appraisalData['ck_cpd'] == 'on' ? 'radio-checked' : ''); ?>">o</span>
                                    <span class="radio-button"></span>
                                </div>
                            </td>
                            <td>CPD –
                                listed, compliant with guidance, with reflection</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>
                                <div class="radio-option">
                                    <span
                                        class="radio-button <?php echo e(isset($appraisalData['ck_quality_improvement_activities']) && $appraisalData['ck_quality_improvement_activities'] == 'on' ? 'radio-checked' : ''); ?>">o</span>
                                    <span class="radio-button"></span>
                                </div>
                            </td>
                            <td>Quality improvement activities – listed, compliant with guidance,with
                                reflection</td>
                            <td></td>
                        </tr>
                    </tbody>
            ...
            <span
                class="radio-button <?php echo e(isset($appraisalData['ck_what_this_checklist_is_for']) && $appraisalData['ck_what_this_checklist_is_for'] == 'on' ? 'radio-checked' : ''); ?>">o</span>
            <span class="radio-button"></span> * Please tick here to confirm your agreement.
...
<?php /**PATH C:\xampp\htdocs\Projects\sf_live\safety\resources\views/pdf/appraisal/sections/section-17.blade.php ENDPATH**/ ?>