    ...
    <div>
        ...
        <div class="section-content">
            ...
            <div class="form-input form-input-large">
                <?php echo e($appraisalData['gmc_knowledge'] ?? ''); ?>
            ...
            <div class="form-input form-input-large">
                <?php echo e($appraisalData['gmc_safety'] ?? ''); ?>
            ...
            <div class="form-input form-input-large">
                <?php echo e($appraisalData['gmc_communication'] ?? ''); ?>
            ...
            <div class="form-input form-input-large">
                <?php echo e($appraisalData['gmc_trust'] ?? ''); ?>
            ...
            <div class="form-input form-input-large">
                <?php echo e($appraisalData['gmc_comments'] ?? ''); ?>
...
<?php /**PATH C:\xampp\htdocs\Projects\sf_live\safety\resources\views/pdf/appraisal/sections/section-16.blade.php ENDPATH**/ ?>