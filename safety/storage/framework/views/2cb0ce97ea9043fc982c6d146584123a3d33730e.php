							...
							<div class="col">
								<div class="date-meta text-uppercase">
									...
									<span><i class="fas fa-user"></i> 
										<?php if(app()->getLocale()=='en'): ?><?php echo e($blog->apBlogCategory->name); ?> <?php else: ?> <?php echo e($blog->apBlogCategory->ar_name); ?> <?php endif; ?>
										</span>
								</div>
							</div>
...
<?php echo $__env->make('appraisal.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/897092.cloudwaysapps.com/qnjpvbnhcv/public_html/safety/resources/views/appraisal/blog-single.blade.php ENDPATH**/ ?>