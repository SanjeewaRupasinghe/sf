<?php $__env->startSection('title', 'Significant events'); ?>
...
$LOCKDOWN_STATUS = Auth::user()->status == 0 ? false : true;
 ...
 <?php if(!$LOCKDOWN_STATUS): ?>
    ...
    <form <?php if($LOCKDOWN_STATUS): ?> action="<?php echo e(route('appraisal.user.significant-events.submit')); ?>" <?php endif; ?> method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="content-body">
                ...
                <div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="significantEvents" id="conditionalQuestionIf"
                            ...
                            <?php if($_sigEvents == 'I have not been named in any significant events in the last year.'): ?> checked <?php endif; ?>>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="significantEvents" id="conditionalQuestionElse"
                            ...
                            <?php if($_sigEvents == 'I have been named in one or more significant events in the last year.'): ?> checked <?php endif; ?>>
            ...
            <div id="conditionalQuestionElseSection"
                <?php if($_sigEvents == 'I have been named in one or more significant events in the last year.'): ?> style="display: block;" <?php else: ?> style="display: none;" <?php endif; ?>>
                <p>
        ...
        <div class="d-flex justify-content-between">
            <a class="btn btn-sm btn-primary" href="<?php echo e(route('appraisal.user.quality-improvement')); ?>">
                < Previous section</a>
<?php if($LOCKDOWN_STATUS): ?>
                    <button type="submit" class="btn btn-sm btn-success">Save Form</button>
                    <?php endif; ?>
                    <a class="btn btn-sm btn-primary" href="<?php echo e(route('appraisal.user.feedback')); ?>">Next section ></a>
        </div>
...
<?php echo $__env->make('appraisal.user.form.layout.appraisal-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Projects\sf_live\safety\resources\views/appraisal/user/form/significant-events.blade.php ENDPATH**/ ?>