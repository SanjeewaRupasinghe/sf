    ...
    <div>
        ...
        <div class="section-content">
                ...
                <table class="form-table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <span
                                    class="radio-button <?php echo e(isset($appraisalData['out_statement_1']) && $appraisalData['out_statement_1'] == 'agree' ? 'radio-checked' : ''); ?>">o</span>
                                <span class="radio-button"></span> Agree
                            </td>
                            <td>
                                <span
                                    class="radio-button <?php echo e(isset($appraisalData['out_statement_1']) && $appraisalData['out_statement_1'] == 'disagree' ? 'radio-checked' : ''); ?>">o</span>
                        ...
                        <tr>
                            ...
                            <td>
                                <span
                                    class="radio-button <?php echo e(isset($appraisalData['out_statement_2']) && $appraisalData['out_statement_2'] == 'agree' ? 'radio-checked' : ''); ?>">o</span>
                                <span class="radio-button"></span> Agree
                            </td>
                            <td>
                                <span
                                    class="radio-button <?php echo e(isset($appraisalData['out_statement_2']) && $appraisalData['out_statement_1'] == 'disagree' ? 'radio-checked' : ''); ?>">o</span>
                                <span class="radio-button"></span> Disagree
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <span
                                    class="radio-button <?php echo e(isset($appraisalData['out_statement_3']) && $appraisalData['out_statement_3'] == 'agree' ? 'radio-checked' : ''); ?>">o</span>
                                <span class="radio-button"></span> Agree
                            </td>
                            <td>
                                <span
                                    class="radio-button <?php echo e(isset($appraisalData['out_statement_3']) && $appraisalData['out_statement_3'] == 'disagree' ? 'radio-checked' : ''); ?>">o</span>
                                <span class="radio-button"></span> Disagree
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <span
                                    class="radio-button <?php echo e(isset($appraisalData['out_statement_4']) && $appraisalData['out_statement_4'] == 'agree' ? 'radio-checked' : ''); ?>">o</span>
                                <span class="radio-button"></span> Agree
                            </td>
                            <td>
                                <span
                                    class="radio-button <?php echo e(isset($appraisalData['out_statement_4']) && $appraisalData['out_statement_4'] == 'disagree' ? 'radio-checked' : ''); ?>">o</span>
                                <span class="radio-button"></span> Disagree
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <span
                                    class="radio-button <?php echo e(isset($appraisalData['out_statement_5']) && $appraisalData['out_statement_5'] == 'agree' ? 'radio-checked' : ''); ?>">o</span>
                                <span class="radio-button"></span> Agree
                            </td>
                            <td>
                                <span
                                    class="radio-button <?php echo e(isset($appraisalData['out_statement_5']) && $appraisalData['out_statement_5'] == 'disagree' ? 'radio-checked' : ''); ?>">o</span>
                                <span class="radio-button"></span> Disagree
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="form-input form-input-large">
                <?php echo e($appraisalData['out_appraiser_comments'] ?? ''); ?>
            ...
            <div class="form-input form-input-large">
                <?php echo e($appraisalData['out_additional_issues'] ?? ''); ?>
            ...
            <div class="form-input form-input-large">
                <?php echo e($appraisalData['out_doctor_response'] ?? ''); ?>
            ...
            <span class="radio-button <?php echo e(isset($appraisalData['out_doctor_confirmation']) && $appraisalData['out_doctor_confirmation'] == 'on' ? 'radio-checked' : ''); ?>">o</span>
            ...
            <div class="form-input form-input-large">
                <?php echo e($appraisalData['out_doctor_full_name'] ?? ''); ?>
            ...
            <div class="form-input form-input-large">
                <?php echo e($appraisalData['out_doctor_gmc_number'] ?? ''); ?>

            </div>

            <div  style="padding: 15px 0px">
             <span class="radio-button <?php echo e(isset($appraisalData['out_appraiser_confirmation']) && $appraisalData['out_appraiser_confirmation'] == 'on' ? 'radio-checked' : ''); ?>">o</span>
            ...
            <div class="form-input form-input-large">
                <?php echo e($appraisalData['out_appraiser_full_name'] ?? ''); ?>
            ...
            <div class="form-input form-input-large">
                <?php echo e($appraisalData['out_appraiser_gmc_number'] ?? ''); ?>
            ...
            <div class="form-input form-input-large">
                <?php echo e($appraisalData['out_appraisal_date'] ?? ''); ?>
...
<?php /**PATH C:\xampp\htdocs\Projects\sf_live\safety\resources\views/pdf/appraisal/sections/section-20.blade.php ENDPATH**/ ?>