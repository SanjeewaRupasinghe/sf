<?php $__env->startSection('title', 'Work of Scope'); ?>
                ...
                <div class="form-section" id="personal-details">
                    <div id="employmentContainer">
                        <div class="dynamic-row">
                            <?php if($_rolesCount > 0): ?>
                                <?php for($i = 0; $i < $_rolesCount; $i++): ?>
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                            <label class="form-label">Job or role title Detail of work</label>
                                            <input type="text" class="form-control" name="role[]"
                                                value="<?php echo e($_roles[$i]->role); ?>">
                                        </div>
                                        <div class="col-md-3 mb-3">
                ...
                <div class="form-section" id="personal-details">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" name="relationship" rows="2"><?php echo e($_relationship); ?></textarea>
                        </div>
                        <div class="col-md-12">
                            <label for="fullName" class="form-label">
                            ...
                            <textarea class="form-control" name="envisageNextYear" rows="2"><?php echo e($_envisageNextYear); ?></textarea>
                        </div>
                        <div class="col-md-12">
                            <label for="fullName" class="form-label">
                            ...
                            <textarea class="form-control" name="comment" rows="2"><?php echo e($_comment); ?></textarea>
...
<?php echo $__env->make('appraisal.user.form.layout.appraisal-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Projects\sf_live\safety\resources\views/appraisal/user/form/scope-of-work.blade.php ENDPATH**/ ?>