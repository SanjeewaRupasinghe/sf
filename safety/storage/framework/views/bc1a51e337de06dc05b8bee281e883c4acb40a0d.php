    ...
    <div>
        ...
        <div class="section-content">
            ...
            <div class="radio-option">
                <span
                    class="radio-button <?php echo e(isset($appraisalData['pb_probityConfirm']) && $appraisalData['pb_probityConfirm'] == 'I have not I have not been named in any complaints in the last year.' ? 'radio-checked' : ''); ?>">o</span>
            ...
            <div style="margin-bottom: 15px">
                ...
                <div class="radio-group">
                    <div class="radio-option">
                        <span
                            class="radio-button <?php echo e(isset($appraisalData['pb_probityDeclaration']) && $appraisalData['pb_probityDeclaration'] == 'nothing' ? 'radio-checked' : ''); ?>">o</span>
                        <span class="radio-button"></span>I have nothing to declare.
                    </div>
                    <div class="radio-option">
                        <span
                            class="radio-button <?php echo e(isset($appraisalData['pb_probityDeclaration']) && $appraisalData['pb_probityDeclaration'] == 'something' ? 'radio-checked' : ''); ?>">o</span>
                        <span class="radio-button radio-checked"></span> I have something to declare.
                    </div>
                </div>

                <!-- ELSE -->
                <?php if(isset($appraisalData['pb_probityDeclaration'])): ?>
                    <?php if($appraisalData['pb_probityDeclaration'] == 'something'): ?>
                        ...
                        <div class="form-input form-input-large">
                            <?php echo e($appraisalData['com_actionsTaken'] ?? ''); ?>
                        ...
                        <div class="form-input form-input-large">
                            <?php echo e($appraisalData['pb_gmcOrOther'] ?? ''); ?>
...
<div class="instruction-text">
    Academy guidance indicates that, when making a health declaration that you accept your professional
                ...
                <div class="radio-option">
                <span
                    class="radio-button <?php echo e(isset($appraisalData['pb_healthConfirm']) && $appraisalData['pb_healthConfirm'] == 'I have not I have not been named in any complaints in the last year.' ? 'radio-checked' : ''); ?>">o</span>
                <span class="radio-button"></span> Please tick here to confirm.
            </div>
            ...
            <p class="mb-3">If you feel that you are unable to make this statement for whatever reason, please explain
                ...
                <div class="form-input form-input-large">
                    <?php echo e($appraisalData['pb_comments'] ?? ''); ?>
...
<?php /**PATH C:\xampp\htdocs\Projects\sf_live\safety\resources\views/pdf/appraisal/sections/section-13.blade.php ENDPATH**/ ?>