                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form class="user" action="<?php echo e(route('admin.store')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <span class="text-danger" id="error"><?php echo e(session('msg')); ?></span>
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" name="username" id="username"  placeholder="Username">
                                        <span class="text-danger" data-placeholder=""><?php $__errorArgs = ['username'];
...
unset($__errorArgs, $__bag); ?></span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="text-danger" data-placeholder=""><?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><?php echo e($message); ?><?php unset($message);
...
<script src="<?php echo e(asset('admins/js/sb-admin-2.min.js')); ?>'"></script>

</body>

</html>
<?php /**PATH /home/897092.cloudwaysapps.com/qnjpvbnhcv/public_html/safety/resources/views/admin/index.blade.php ENDPATH**/ ?>