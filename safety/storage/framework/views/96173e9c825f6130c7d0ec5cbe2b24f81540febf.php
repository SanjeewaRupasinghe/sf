<div>
    <div>
        ...
        <div class="section-content">
            ...
            <div style="margin-bottom: 15px">
                ...
                <div class="radio-group">
                    <div class="radio-option">
                        <span
                            class="radio-button <?php echo e(isset($appraisalData['cpd_royalCollege']) && $appraisalData['cpd_royalCollege'] == 'yes' ? 'radio-checked' : ''); ?>">o</span>
                        <span class="radio-button"></span> Yes
                    </div>
                    <div class="radio-option">
                        <span
                            class="radio-button <?php echo e(isset($appraisalData['cpd_royalCollege']) && $appraisalData['cpd_royalCollege'] == 'no' ? 'radio-checked' : ''); ?>">o</span>
            ...
            <!-- IF -->
            <?php if(isset($appraisalData['cpd_royalCollege'])): ?>
                <?php if($appraisalData['cpd_royalCollege'] == 'yes'): ?>
                    <div style="margin-bottom: 15px">
                        ...
                        <div class="radio-group">
                            <div class="radio-option">
                                <span
                                    class="radio-button <?php echo e(isset($appraisalData['cpd_annualCertificate']) && $appraisalData['cpd_annualCertificate'] == 'yes' ? 'radio-checked' : ''); ?>">o</span>
                                <span class="radio-button"></span> Yes
                            </div>
                            <div class="radio-option">
                                <span
                                    class="radio-button <?php echo e(isset($appraisalData['cpd_annualCertificate']) && $appraisalData['cpd_annualCertificate'] == 'no' ? 'radio-checked' : ''); ?>">o</span>
                                <span class="radio-button radio-checked"></span> No
                            </div>
                        </div>
                    </div>
                    <div style="margin-bottom: 15px">
                        ...
                        <div class="radio-group">
                            <div class="radio-option">
                                <span
                                    class="radio-button <?php echo e(isset($appraisalData['cpd_additionalCPD']) && $appraisalData['cpd_additionalCPD'] == 'yes' ? 'radio-checked' : ''); ?>">o</span>
                                <span class="radio-button"></span> Yes
                            </div>
                            <div class="radio-option">
                                <span
                                    class="radio-button <?php echo e(isset($appraisalData['cpd_additionalCPD']) && $appraisalData['cpd_additionalCPD'] == 'no' ? 'radio-checked' : ''); ?>">o</span>
                                <span class="radio-button radio-checked"></span> No
                            </div>
                        </div>
                    </div>
            ...
            <!-- ELSE -->
            <?php if(isset($appraisalData['cpd_royalCollege'])): ?>
                <?php if($appraisalData['cpd_royalCollege'] == 'no'): ?>
                    <div style="margin-bottom: 15px">
                        ...
                        <div class="radio-group">
                            <div class="radio-option">
                                <span
                                    class="radio-button <?php echo e(isset($appraisalData['cpd_cpdDiary']) && $appraisalData['cpd_cpdDiary'] == 'yes' ? 'radio-checked' : ''); ?>">o</span>
                                <span class="radio-button"></span> Yes
                            </div>
                            <div class="radio-option">
                                <span
                                    class="radio-button <?php echo e(isset($appraisalData['cpd_cpdDiary']) && $appraisalData['cpd_cpdDiary'] == 'no' ? 'radio-checked' : ''); ?>">o</span>
                                <span class="radio-button radio-checked"></span> No
                            </div>
                        </div>
                    </div>
            ...
            <!-- DIARY IF-->
            <?php if(isset($appraisalData['cpd_cpdDiary'])): ?>
                <?php if($appraisalData['cpd_cpdDiary'] == 'yes'): ?>
            ...
            <div class="form-input form-input-large">
                <?php echo e($appraisalData['cpd_practice'] ?? ''); ?>
            ...
            <div class="form-input form-input-large">
                <?php echo e($appraisalData['cpd_comments'] ?? ''); ?>
...
<?php /**PATH C:\xampp\htdocs\Projects\sf_live\safety\resources\views/pdf/appraisal/sections/section-7.blade.php ENDPATH**/ ?>