...
<?php $__env->startSection('content'); ?>
    ...
    <h1 class="h3 mb-4 text-gray-800">New Category <a href="<?php echo e(route('category.index')); ?>" class="btn btn-info float-right">Back</a></h1>
    <div class="card shadow mb-4">
        <div class="card-body">
        <div class="row">
            <div class="col-sm-12" >
                <form action="<?php echo e(route('category.store')); ?>" method="post"  name="fname" enctype="multipart/form-data" role="form" id="formm">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                            ...
                            <div class="tree-container">                                    
                                ...
                                <div class="tree-item active  <?php echo e(($cat->children)?'has-children':''); ?>">
                                    ...
                                    <?php if(count($cat->children)): ?>
                                        <?php echo $__env->make('admin.categoryChild',['children' => $cat->children], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php endif; ?>                                
                                    </div>
...
<script>
    $(function() {
        $('#name,#slug').blur(function () {
            $.ajax({
                method: "GET",
                url: "<?php echo e(route('category.checkSlug3')); ?>",
                data: {"name": $(this).val()}
            }).done(function (data) {
                $('#slug').val(data.slug);
            });
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/897092.cloudwaysapps.com/qnjpvbnhcv/public_html/safety/resources/views/admin/category_add.blade.php ENDPATH**/ ?>