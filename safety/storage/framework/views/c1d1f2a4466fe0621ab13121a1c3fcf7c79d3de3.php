					...
					<div class="col-sm-12 form-group">
						...
						<label for="basiInput" class="form-label" style="font-size: 14px;"><b>I
							<?php echo app('translator')->get('common.Terms1'); ?>
								<a href="<?php echo e(asset('appraisal/terms')); ?>" class="text-primary">
...
<?php echo $__env->make('appraisal.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/897092.cloudwaysapps.com/qnjpvbnhcv/public_html/safety/resources/views/appraisal/paynow.blade.php ENDPATH**/ ?>