                            ...
                            <tr>
                                ...
                                <td>]
                                    <a class="primary-button"
                                        href="<?php echo e(route('appraisal.user.file.download', ['fileName' => $appraisalData['an_new_filename']])); ?>">View</a>
                                </td>
                            </tr>
                        <?php endif; ?>
                                ...
                                <?php if($r->supportingInfo == 'Attached'): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if($att): ?>
                                                <a class="primary-button"
                                                    href="<?php echo e(route('appraisal.user.file.download', ['fileName' => $r->new_filename])); ?>">View</a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endif; ?>
