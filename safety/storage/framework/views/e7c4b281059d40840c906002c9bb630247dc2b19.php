                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="blog-post-img-content">
                                    ...
                                    <div class="blog-title-content headline">
                                        <h3>
                                            <a href="<?php echo e(asset('/appraisal/blog/'.$blog->slug)); ?>">
                                        ...
                                        <div class="view-all-btn bold-font">
                                            <a href="<?php echo e(asset('/appraisal/blog/'.$blog->slug)); ?>"><?php echo app('translator')->get('course/innerpage.Readmore'); ?> <i class="fas fa-chevron-circle-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>	
...
<?php echo $__env->make('appraisal.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/897092.cloudwaysapps.com/qnjpvbnhcv/public_html/safety/resources/views/appraisal/blogs.blade.php ENDPATH**/ ?>