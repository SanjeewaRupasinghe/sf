<?php $__env->startSection('title', 'Summary of the appraisal discussion'); ?>
...
$LOCKDOWN_STATUS = Auth::user()->status == 0 ? false : true;
    ...
    <form <?php if($LOCKDOWN_STATUS): ?> action="<?php echo e(route('appraisal.user.summary.submit')); ?>" <?php endif; ?> method="POST">
        <?php echo csrf_field(); ?>
        ...
        <div class="content-body">
                ...
                <div class="col-12">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="scope_of_work" id="scope_of_work" rows="3"
                            placeholder="Note for appraiser: Text entered here will mirror automatically between the corresponding 'Appraiser's comments' boxes and 'Section 19 Summary of the appraisal discussion' boxes."><?php echo e($_scope_of_work); ?></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="personal_development_plans" id="personal_development_plans" rows="3"
                            placeholder="Note for appraiser: Text entered here will mirror automatically between the corresponding 'Appraiser's comments' boxes and 'Section 19 Summary of the appraisal discussion' boxes."><?php echo e($_personal_development_plans); ?></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="continuing_professional_development" id="continuing_professional_development"
                            rows="3"
                            placeholder="Note for appraiser: Text entered here will mirror automatically between the corresponding 'Appraiser's comments' boxes and 'Section 19 Summary of the appraisal discussion' boxes."><?php echo e($_continuing_professional_development); ?></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="quality_improvement_activity" id="quality_improvement_activity" rows="3"
                            placeholder="Note for appraiser: Text entered here will mirror automatically between the corresponding 'Appraiser's comments' boxes and 'Section 19 Summary of the appraisal discussion' boxes."><?php echo e($_quality_improvement_activity); ?></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="significant_events" id="significant_events" rows="3"
                            placeholder="Note for appraiser: Text entered here will mirror automatically between the corresponding 'Appraiser's comments' boxes and 'Section 19 Summary of the appraisal discussion' boxes."><?php echo e($_significant_events); ?></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="feedback_colleagues_patients" id="feedback_colleagues_patients" rows="6"
                            placeholder="Note for appraiser: Text entered here will mirror automatically between the corresponding 'Appraiser's comments' boxes and 'Section 19 Summary of the appraisal discussion' boxes."><?php echo e($_feedback_colleagues_patients); ?></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="review_complaints_procedures" id="review_complaints_procedures" rows="3"
                            placeholder="Note for appraiser: Text entered here will mirror automatically between the corresponding 'Appraiser's comments' boxes and 'Section 19 Summary of the appraisal discussion' boxes."><?php echo e($_review_complaints_procedures); ?></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="achievements_challenges_aspirations" id="achievements_challenges_aspirations"
                            rows="3"
                            placeholder="Note for appraiser: Text entered here will mirror automatically between the corresponding 'Appraiser's comments' boxes and 'Section 19 Summary of the appraisal discussion' boxes."><?php echo e($_achievements_challenges_aspirations); ?></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="additional_information" id="additional_information" rows="3"
                            placeholder="Note for appraiser: Text entered here will mirror automatically between the corresponding 'Appraiser's comments' boxes and 'Section 19 Summary of the appraisal discussion' boxes."><?php echo e($_additional_information); ?></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        <textarea class="form-control" name="context_general_summary" id="context_general_summary" rows="6"><?php echo e($_context_general_summary); ?></textarea>
                    </div>
            ...
            <div class="d-flex justify-content-between">
                <a class="btn btn-sm btn-primary" href="<?php echo e(route('appraisal.user.development-plan')); ?>">
                    < Previous section</a>
                    <?php if($LOCKDOWN_STATUS): ?>
                        <button type="submit" class="btn btn-sm btn-success">Save Form</button>
                        <?php endif; ?>
                        <a class="btn btn-sm btn-primary" href="<?php echo e(route('appraisal.user.outputs')); ?>">Next section ></a>
            </div>
...
<?php echo $__env->make('appraisal.user.form.layout.appraisal-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Projects\sf_live\safety\resources\views/appraisal/user/form/summary.blade.php ENDPATH**/ ?>