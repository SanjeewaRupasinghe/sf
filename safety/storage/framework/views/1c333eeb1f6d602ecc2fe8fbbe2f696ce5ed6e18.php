    ...
    <div class="content-body">
        ...
        <div class="content-subsection">
            ...
            <div class="d-flex justify-content-between">
                <a class="btn btn-sm btn-primary" href="<?php echo e(route('appraisal.user.index')); ?>">
                    < Previous section</a>
                        <a class="btn btn-sm btn-primary" href="<?php echo e(route('appraisal.user.personal-details')); ?>">Next section ></a>
            </div>
...
<?php echo $__env->make('appraisal.user.form.layout.appraisal-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Projects\sf_live\safety\resources\views/appraisal/user/form/instructions.blade.php ENDPATH**/ ?>