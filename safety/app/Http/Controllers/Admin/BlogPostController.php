...
class BlogPostController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.blog_post_list',compact('results'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.blog_post_add',compact('categories'));
    }
    ...
    public function store(StoreBlogPostRequest $request)
    {
        ...
        if($result)
        {
            return redirect()->route('blogPost.index')->with('msg','Saved successfully');
        }
        else
        {
            return redirect()->route('blogPost.create')->with('msg','Not saved successfully'); 
        }
    }
    ...
    public function edit(BlogPost $blogPost)
    {
        ...
        return view('admin.blog_post_edit',compact('categories','blogPost'));
    }
    ...
    public function checkSlug2(Request $request)
    {
        ...
        $i=2;
        if(!BlogPost::all()->where('slug',$slug)->isEmpty())
        {
            $newslug  = $slug.'-'.$i;
            while(!BlogPost::all()->where('slug',$newslug)->isEmpty())
            {
                $i++;
                $newslug  = $slug.'-'.$i;
            }
