...
class WFACP_Compatibility_With_Angel_Eye_PPCP
{
    public function __construct()
    {
        ...
        add_action('woocommerce_checkout_update_order_meta', [$this, 'update_checkout_id'], 10, 2);
    ...
    public function update_checkout_id($order_id, $data)
    {
        if (!class_exists('AngellEYE_PayPal_PPCP_Front_Action') || !isset($_GET['angelleye_ppcp_action']) || !isset($_GET['wfacp_id']) || empty($order_id)) {
            return;
        }

        update_post_meta($order_id, '_wfacp_post_id', $_GET['wfacp_id']);
