...
//				$wfacp_elementor_hide_field = 'wfacp_elementor_hide_field';
	...
	private function global_typography() {
		...
		$default_link_hover_color_option = [
			...
			'{{WRAPPER}} #wfacp-e-form a:not(.wfacp_close_icon):not(.button-social-login):not(.wfob_btn_add):not(.ywcmas_shipping_address_button_new):not(.wfob_qv-button):not(.wfob_read_more_link):not(.wfacp_step_text_have ):not(.wfacp_cart_link):not(.wfacp_summary_link):hover',
		];
