...
abstract class WFACP_OXY_HTML_BLOCK extends WFACP_OXY_Field {
	...
	protected function order_coupon( $field_key ) {
		...
		$coupon_typography_opt = [
			'#wfacp-e-form #wfacp-e-form .wfacp-coupon-section .wfacp-coupon-page .woocommerce-info > a',
			'#wfacp-e-form #wfacp-e-form .wfacp-coupon-section .wfacp-coupon-page .woocommerce-info > a:not(.wfacp_close_icon):not(.button-social-login):not(.wfob_btn_add):not(.ywcmas_shipping_address_button_new):not(.wfob_qv-button):not(.wfob_read_more_link):not(.wfacp_step_text_have ):not(.wfacp_cart_link)',
		];
