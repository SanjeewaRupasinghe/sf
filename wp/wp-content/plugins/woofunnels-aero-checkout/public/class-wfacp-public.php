...
class WFACP_Public {
	...
	public function calculate_totals( $ins ) {
		...
		/* Do not apply discount at page load . Calculate discount  when update order review ajax run OR ajax running */

		if ( ! wp_doing_ajax() && true == apply_filters( 'wfacp_enable_delay_discounting', true, $this ) ) {
			return $ins;
		}
