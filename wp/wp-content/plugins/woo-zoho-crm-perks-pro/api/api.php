...
if(!empty($post['vx_ship_entry'])){
 $post['Product_Details'][]=array('product'=>array('id'=>$post['vx_ship_entry']),'quantity'=>1,'list_price'=>floatval($post['shipping_charge'])); 
}
...
public function push_object_invoice($module,$fields,$meta){
  //   $res=$this->post_crm('invoices/183210000000036199'); var_dump($res); die();
