...
define('PAYFORT_FORT_PAYMENT_METHOD_APPLEPAY', 'payfort_fort_applepay');
...
// APPLE PAY WEB CONFIGS

$ap_key  = WP_CONTENT_DIR . "/apwcertificates/Certificate.key.pem";
$ap_cert = WP_CONTENT_DIR . "/apwcertificates/ApplePay.crt.pem";

define('APW_MERCHANT_IDENTIFIER', 'merchant.safetyfirstmed.test');
define('APW_DOMAIN_NAME', 'safetyfirstmed.ae');
define('APW_DISPLAY_NAME', 'Safety First');
define('APW_CERTIFICATE_PATH', $ap_cert);
define('APW_CERTIFICATE_KEY', $ap_key);
define('APW_CERTIFICATE_KEY_PASS', '');
