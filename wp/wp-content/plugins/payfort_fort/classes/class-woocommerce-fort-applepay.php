...
class WC_Gateway_Payfort_Fort_Applepay extends WC_Gateway_Payfort
{

    public $id = PAYFORT_FORT_PAYMENT_METHOD_APPLEPAY;

    public function __construct()
    {
        parent::__construct();
        $this->title        = __('ApplePay', 'payfort_fort');
        $this->method_title = 'Payfort ApplePay';
        $this->description  = __('Pay for your items with using ApplePay payment method', 'payfort_fort');
