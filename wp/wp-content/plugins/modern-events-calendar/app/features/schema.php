                ...
                <div class="mec-form-row">
                    <input
                        ...
                        ?>
                            ...
                            for="mec_display_cancellation_reason_in_single_page"><?php esc_html_e('Display in single event page', 'mec'); ?></label>
                </div>
            </div>
            <div class="mec-form-row">
                <label>
    ...
    public function schema($event)
    {
        ...
        $this->factory->printOnAjaxOrFooter(function() use($event, $event_status, $start_date, $end_date, $moved_online_link, $event_link, $location, $organizer, $cost, $soldout, $content, $speakers)
        {
            ...
            <script type="application/ld+json">
            {
                ...
                "description": "<?php echo (preg_replace('/<p>\\s*?(<a .*?><img.*?><\\/a>|<img.*?>)?\\s*<\\/p>/s', '<div class="figure">$1</div>', preg_replace('/\s/u', ' ', $content))); ?>",
