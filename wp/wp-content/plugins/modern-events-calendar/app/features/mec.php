...
class MEC_feature_mec extends MEC_base
{
    ...
    public function menus()
    {
        ...
        add_submenu_page('mec-intro', esc_html__('Add Event', 'mec'), esc_html__('Add Event', 'mec'), 'edit_posts', 'post-new.php?post_type='.$this->PT);
        add_submenu_page('mec-intro', esc_html__('Tags', 'mec'), esc_html__('Tags', 'mec'), 'edit_others_posts', 'edit-tags.php?taxonomy='.apply_filters('mec_taxonomy_tag', '').'&post_type='.$this->PT);
        add_submenu_page('mec-intro', esc_html($this->main->m('taxonomy_categories', esc_html__('Categories', 'mec'))), esc_html($this->main->m('taxonomy_categories', esc_html__('Categories', 'mec'))), 'edit_others_posts', 'edit-tags.php?taxonomy=mec_category&post_type='.$this->PT);
        add_submenu_page('mec-intro', esc_html($this->main->m('taxonomy_labels', esc_html__('Labels', 'mec'))), esc_html($this->main->m('taxonomy_labels', esc_html__('Labels', 'mec'))), 'edit_others_posts', 'edit-tags.php?taxonomy=mec_label&post_type='.$this->PT);
        add_submenu_page('mec-intro', esc_html($this->main->m('taxonomy_locations', esc_html__('Locations', 'mec'))), esc_html($this->main->m('taxonomy_locations', esc_html__('Locations', 'mec'))), 'edit_others_posts', 'edit-tags.php?taxonomy=mec_location&post_type='.$this->PT);
        add_submenu_page('mec-intro', esc_html($this->main->m('taxonomy_organizers', esc_html__('Organizers', 'mec'))), esc_html($this->main->m('taxonomy_organizers', esc_html__('Organizers', 'mec'))), 'edit_others_posts', 'edit-tags.php?taxonomy=mec_organizer&post_type='.$this->PT);

        // Speakers Menu
        if(isset($this->settings['speakers_status']) and $this->settings['speakers_status'])
        {
            add_submenu_page('mec-intro', esc_html($this->main->m('taxonomy_speakers', esc_html__('Speakers', 'mec'))), esc_html($this->main->m('taxonomy_speakers', esc_html__('Speakers', 'mec'))), 'edit_others_posts', 'edit-tags.php?taxonomy=mec_speaker&post_type='.$this->PT);
        }
        ...
        add_submenu_page('mec-intro', esc_html__('MEC - Settings', 'mec'), esc_html__('Settings', 'mec'), $capability, 'MEC-settings', array($this, 'page'));

        add_submenu_page('mec-intro', esc_html__('MEC - Addons', 'mec'), esc_html__('Addons', 'mec'), 'manage_options', 'MEC-addons', array($this, 'addons'));
        add_submenu_page('mec-intro', esc_html__('MEC - Wizard', 'mec'), esc_html__('Wizard', 'mec'), 'manage_options', 'MEC-wizard', array($this, 'setup_wizard'));
        ...
        if(!$this->getPRO()) add_submenu_page('mec-intro', esc_html__('MEC - Go Pro', 'mec'), esc_html__('Go Pro', 'mec'), 'manage_options', 'MEC-go-pro', array($this, 'go_pro'));
