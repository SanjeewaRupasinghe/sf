...
class MEC_feature_events extends MEC_base
{
                ...
                <div class="mec-form-row mec-all-day-event">
                    <input
                        ...
                        ?>
                            ...
                            for="mec_allday"><?php esc_html_e('All-day Event', 'mec'); ?></label>
                </div>
                <div class="mec-form-row">
                    <input
                        <?php
                        ...
                        ?>
                            ...
                            for="mec_hide_time"><?php esc_html_e('Hide Event Time', 'mec'); ?></label>
                </div>
                <div class="mec-form-row">
                    <input
                        <?php
                        ...
                        ?>
                            ...
                            for="mec_hide_end_time"><?php esc_html_e('Hide Event End Time', 'mec'); ?></label>
                </div>
                <div class="mec-form-row">
                    <div class="mec-col-4">
                ...
                <div class="mec-form-row">
                    <input
                        ...
                        ?>
                            ...
                            for="mec_repeat"><?php esc_html_e('Event Repeating (Recurring events)', 'mec'); ?></label>
                </div>
                    ...
                    <div id="mec_end_wrapper">
                        <div class="mec-form-row">
                            <label for="mec_repeat_ends_never">
                                <h4 class="mec-title"><?php esc_html_e('Ends Repeat', 'mec'); ?></h4>
                            </label>
                        </div>
                        <div class="mec-form-row">
                            <input
                    ...
                    <div class="mec-form-row">
                        <div class="mec-col-12">
                            ...
                            <button class="button" type="button"
                                    id="mec_add_not_in_days"><?php esc_html_e('Add', 'mec'); ?></button>
                            <span class="mec-tooltip">
								<div class="box top">
                ...
                <span class="mec-tooltip">
					<div class="box top">
						...
						<div class="content"><p><?php esc_attr_e('If you fill it, it will replace the default event page link. Insert full link including http(s):// - Also, if you use advertising URL, can use URL Shortener', 'mec'); ?>
                                <a href="https://bit.ly/"
                                   target="_blank"><?php esc_html_e('URL Shortener', 'mec'); ?></a></p></div>
					</div>
					<i title="" class="dashicons-before dashicons-editor-help"></i>
				</span>
            </div>
    ...
    public function meta_box_booking_options($post)
    {
        ...
        <div id="mec-booking">
            <div class="mec-meta-box-fields mec-booking-tab-content mec-tab-active mec-fes-booking-options" id="mec_meta_box_booking_options_form_1">
                ...
                <div class="mec-form-row">
                    <label class="mec-col-4" for="mec_booking_show_booking_form_interval"><?php esc_html_e('Show Booking Form Interval', 'mec'); ?></label>
                    <div class="mec-col-4">
    ...
    public function meta_box_tickets($post)
    {
        ...
        <div class="mec-meta-box-fields mec-booking-tab-content mec-fes-tickets" id="mec-tickets">
            <h4 class="mec-meta-box-header"><?php echo esc_html($this->main->m('tickets', esc_html__('Tickets', 'mec'))); ?></h4>
                ...
                <div id="mec_tickets">
                    ...
                    foreach($tickets as $key => $ticket)
                    {
                        ...
                        <div class="mec-box" id="mec_ticket_row<?php echo esc_attr($key); ?>">
                            <div class="mec-ticket-id" title="<?php esc_attr_e('Ticket ID', 'mec'); ?>"><span class="mec-ticket-id-title"><?php esc_attr_e('ID', 'mec'); ?>: </span><?php echo esc_attr($key); ?></div>
                            <div class="mec-form-row">
                            ...
                            <div class="mec-form-row">
                                <div class="mec-col-4">
                                    <input type="text" name="mec[tickets][<?php echo esc_attr($key); ?>][minimum_ticket]" value="<?php echo(isset($ticket['minimum_ticket']) ? esc_attr($ticket['minimum_ticket']) : '0'); ?>" placeholder="<?php esc_html_e('Minimum Ticket e.g. 3', 'mec'); ?>">
                                    <span class="mec-tooltip">
                                        <div class="box top">
                                            <h5 class="title"><?php esc_html_e('MinimumTicket', 'mec'); ?></h5>
                                            <div class="content">
                            ...
                            <div class="mec-form-row">
                                <?php ob_start(); ?>
                                <input type="number" class="mec-stop-selling-tickets" name="mec[tickets][<?php echo esc_attr($key); ?>][stop_selling_value]" value="<?php echo((isset($ticket['stop_selling_value']) and trim($ticket['stop_selling_value'])) ? esc_attr($ticket['stop_selling_value']) : '0'); ?>" placeholder="<?php esc_html_e('e.g. 0', 'mec'); ?>">
                                ...
                                <?php echo sprintf(esc_html__('Stop selling ticket %s before event start.', 'mec'), ob_get_clean()); ?>
                                    ...
                                    <div id="mec_variations_per_ticket_form<?php echo esc_attr($key); ?>">
                                        <div class="mec-form-row">
                                            <label>
                                                ...
                                                <input onchange="jQuery('#mec_variations_per_ticket_container_toggle<?php echo esc_attr($key); ?>').toggle();" value="1" type="checkbox" name="mec[tickets][<?php echo esc_attr($key); ?>][variations_event_inheritance]" <?php echo ($event_inheritance ? 'checked="checked"' : ''); ?>> <?php esc_html_e('Inherit from event options', 'mec'); ?>
                                            </label>
                                        </div>
                                        <div id="mec_variations_per_ticket_container_toggle<?php echo esc_attr($key); ?>" class="<?php echo ($event_inheritance ? 'mec-util-hidden' : ''); ?>">
                                            <div class="mec-form-row">
                                                <button class="button" type="button" id="mec_add_variation_per_ticket_button<?php echo esc_attr($key); ?>" onclick="add_variation_per_ticket(<?php echo esc_attr($key); ?>);"><?php esc_html_e('Add', 'mec'); ?></button>
                                            </div>
            ...
            <div class="mec-util-hidden" id="mec_new_ticket_raw">
                <div class="mec-box" id="mec_ticket_row:i:">
                    ...
                    <div class="mec-form-row">
						<span class="mec-col-4">
							<input type="number" min="0" step="0.01" name="mec[tickets][:i:][price]" placeholder="<?php esc_attr_e('Price', 'mec'); ?>" value="0">
							<span class="mec-tooltip">
								<div class="box top">
									<h5 class="title"><?php esc_html_e('Price', 'mec'); ?></h5>
									<div class="content"><p><?php esc_attr_e('Insert 0 for free ticket. Only numbers please — Enter only the price without any symbols or characters.', 'mec'); ?>
                    ...
                    <div class="mec-form-row">
                        <div class="mec-col-4">
                            <input type="text" name="mec[tickets][:i:][minimum_ticket]" value="1" placeholder="<?php esc_html_e('Minimum Ticket e.g. 3', 'mec'); ?>">
                            <span class="mec-tooltip">
                                <div class="box top">
                                    <h5 class="title"><?php esc_html_e('MinimumTicket', 'mec'); ?></h5>
                                    <div class="content">
                    ...
                    <div class="mec-form-row">
                        <?php ob_start(); ?>
                        <input type="number" class="mec-stop-selling-tickets" name="mec[tickets][:i:][stop_selling_value]" value="0" placeholder="<?php esc_html_e('e.g. 0', 'mec'); ?>">
                            ...
                            <div id="mec_variations_per_ticket_form:i:">
                                <div class="mec-form-row">
                                    <label>
                                        ...
                                        <input onchange="jQuery('#mec_variations_per_ticket_container_toggle:i:').toggle();" value="1" type="checkbox" name="mec[tickets][:i:][variations_event_inheritance]" checked="checked"> <?php esc_html_e('Inherit from event options', 'mec'); ?>
                                    </label>
                                </div>
                                <div id="mec_variations_per_ticket_container_toggle:i:" class="mec-util-hidden">
                                    <div class="mec-form-row">
                                        <button class="button" type="button" id="mec_add_variation_per_ticket_button:i:" onclick="add_variation_per_ticket(:i:);"><?php esc_html_e('Add', 'mec'); ?></button>
                                    </div>
    ...
    public function action_links($actions, $post)
    {
        ...
        // Booking Button
        if($this->getPRO() and isset($this->settings['booking_status']) and $this->settings['booking_status']) $actions['mec-bookings'] = '<a href="'.esc_url($this->main->add_qs_vars(array('post_type'=>$this->main->get_book_post_type(), 'mec_event_id'=>$post->ID), trim($this->main->URL('admin'), '/ ').'/edit.php')).'">'.esc_html__('Bookings', 'mec').'</a>';
        ...
        if(count($attendees))
        {
            $html .= '<div class="w-clearfix mec-attendees-head">
                ...
                <div class="w-col-xs-3 ticket">
                    <span>'.esc_html($this->main->m('ticket', esc_html__('Ticket', 'mec'))).'</span>
                </div>
    ...
    public function mec_event_bookings()
    {
        ...
        {
            $html .= '<p>'.esc_html__("No Bookings Found!", 'mec').'</p>';
        }
