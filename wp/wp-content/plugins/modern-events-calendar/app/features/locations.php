    ...
    ?>
        <div class="mec-meta-box-fields mec-event-tab-content" id="mec-location">
			...
			<div class="mec-form-row">
				<select name="mec[location_id]" id="mec_location_id" title="<?php echo esc_attr__($this->main->m('taxonomy_location', esc_html__('Location', 'mec')), 'mec'); ?>">
                ...
                <span class="mec-tooltip">
                    <div class="box top">
                        ...
                        <div class="content"><p><?php esc_attr_e('Choose one of saved locations or insert new one below.', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/location/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                    </div>
			...
			<div id="mec_location_new_container">
                ...
                <div class="mec-form-row">
                    <input type="url" name="mec[location][url]" id="mec_location_url" value="" placeholder="<?php esc_html_e('Location Website', 'mec'); ?>" />
                </div>
				...
				<div class="mec-form-row mec-thumbnail-row">
					...
					<button type="button" class="mec_location_remove_image_button button mec-util-hidden"><?php echo esc_html__('Remove image', 'mec'); ?></button>
				</div>
                <?php else: ?>
                <div class="mec-form-row mec-thumbnail-row">
            ...
            <div class="mec-form-row">
                ...
                <input type="checkbox" id="mec_location_dont_show_map" name="mec[dont_show_map]" value="1" <?php echo ($dont_show_map ? 'checked="checked"' : ''); ?> /><label for="mec_location_dont_show_map"><?php echo esc_html__("Don't show map in single event page", 'mec'); ?></label>
            </div>
            <?php endif; ?>
            <?php if($additional_locations_status and count($locations)): ?>
            <h4><?php echo esc_html($this->main->m('other_locations', esc_html__('Other Locations', 'mec'))); ?></h4>
            <div class="mec-form-row">
                <p><?php esc_html_e('You can select extra locations in addition to main location if you like.', 'mec'); ?></p>
