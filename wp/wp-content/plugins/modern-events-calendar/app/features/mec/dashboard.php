                        ...
                        <div class="box-mec-avtivation">
                            ...
                            <form id="MECActivation" action="#" method="post">
                                ...
                                <div class="MECLicenseMessage mec-message-hidden">
                                    <?php
                                    echo esc_html__('Activation failed. Please check your purchase code or license type. Note: Your purchase code should match your licesne type.', 'mec') . '<a style="text-decoration: underline; padding-left: 7px;" href="https://webnus.net/dox/modern-events-calendar/auto-update-issue/" target="_blank">'  . esc_html__('Troubleshooting', 'mec') . '</a>';
                                    ?>
                                </div>
                            </form>
                        </div>
