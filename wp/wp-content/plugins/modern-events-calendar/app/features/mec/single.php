                ...
                <div class="mec-container">
                    ...
                    <form id="mec_single_form">
                                ...
                                <div class="mec-col-9">
                                    ...
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                            ...
                                            <div class="content"><p><?php esc_attr_e("Default is M d Y", 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/event-detailssingle-event-page/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                                        </div>
                                ...
                                <div class="mec-col-9">
                                    ...
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                            ...
                                            <div class="content"><p><?php esc_attr_e('Referred date" shows the event date based on referred date in event list.', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/event-detailssingle-event-page/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                                        </div>
                                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                                    </span>
                                </div>
                                ...
                                <div class="mec-col-9">
                                    ...
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                            ...
                                            <div class="content"><p><?php esc_attr_e("If you want to use the new WordPress block editor you should keep this checkbox unchecked.", 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/event-detailssingle-event-page/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                                        </div>
                                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                                    </span>
                                </div>
                                ...
                                <div class="mec-col-9">
                                    ...
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                            ...
                                            <div class="content"><p><?php esc_attr_e("Check this option, for showing the breadcrumbs on single event page", 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/event-detailssingle-event-page/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                                        </div>
                                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                                    </span>
                                </div>
                                ...
                                <div class="mec-form-row">
                                    ...
                                    <div class="mec-col-9">
                                        <label>
                                            ...
                                            <input type="checkbox" name="mec[settings][breadcrumbs_category]" id="mec_settings_breadcrumbs_category" <?php echo ((isset($settings['breadcrumbs_category']) and $settings['breadcrumbs_category']) ? 'checked="checked"' : ''); ?> value="1" /><?php esc_html_e('Include Category in Breadcrumbs.', 'mec'); ?>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mec-form-row">
                                ...
                                <div class="mec-col-9">
                                    <label id="mec_settings_organizer_description" >
                                        ...
                                        <input type="checkbox" name="mec[settings][organizer_description]" id="mec_settings_organizer_description" <?php echo ((isset($settings['organizer_description']) and $settings['organizer_description']) ? 'checked="checked"' : ''); ?> value="1" /><?php esc_html_e('Enable Description For Organizer.', 'mec'); ?>
                                    </label>
                                    <span class="mec-tooltip">
                                        <div class="box left">
                            ...
                            <div class="mec-form-row">
                                ...
                                <div class="mec-col-9">
                                    <label id="mec_settings_location_description" >
                                        ...
                                        <input type="checkbox" name="mec[settings][location_description]" id="mec_settings_location_description" <?php echo ((isset($settings['location_description']) and $settings['location_description']) ? 'checked="checked"' : ''); ?> value="1" /><?php esc_html_e('Enable Description For Location.', 'mec'); ?>
                                    </label>
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                ...
                                <div class="mec-col-9">
                                    ...
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                            ...
                                            <div class="content"><p><?php esc_attr_e("If enabled, an upload field will appear in add / edit event page and if filled, it will appear in the event details page to download.", 'mec'); ?></p></div>
                                        </div>
                                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                                    </span>
                                </div>
                                ...
                                <div class="mec-col-9">
                                    ...
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                            ...
                                            <div class="content"><p><?php esc_attr_e("If the  content you wish to display on the page is too long, then enable this option to make the sidebar sticky and view the content via scrolling down. If you're sidebar has a lot of data and is a long sidebar, we don't recommend enabling this option.", 'mec'); ?></p></div>
                                        </div>
                                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                                    </span>
                                </div>
                            ...
                            <div id="mec_count_down_container_toggle" class="<?php if((isset($settings['countdown_status']) and !$settings['countdown_status']) or !isset($settings['countdown_status'])) echo 'mec-util-hidden'; ?>">
                                ...
                                <div class="mec-form-row">
                                    <div class="mec-col-12">
                                        ...
                                        <label for="mec_settings_countdown_disable_for_ongoing_events"><?php esc_html_e('Disable for ongoing events', 'mec'); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="exceptional_option" class="mec-options-fields">
                            ...
                            <div class="mec-form-row">
                                <label>
                                    ...
                                    <input value="1" type="checkbox" name="mec[settings][exceptional_days]" <?php if(isset($settings['exceptional_days']) and $settings['exceptional_days']) echo 'checked="checked"'; ?> /> <?php esc_html_e('Show exceptional days option on Add/Edit events page', 'mec'); ?>
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                            <h5 class="title"><?php esc_html_e('Exceptional days (Exclude Dates)', 'mec'); ?></h5>
                                            <div class="content"><p><?php esc_attr_e("Using this option you can exclude certain days from event occurrence dates.", 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/exceptional-days/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                                        </div>
                                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                                    </span>
                                </label>
                        ...
                        <div id="per_occurrences" class="mec-options-fields">
                            <h4 class="mec-form-subtitle"><?php esc_html_e('Edit Per Occurrences', 'mec'); ?></h4>
                            <div class="mec-form-row">
                                <label>
                        ...
                        <div id="shortcode_only_bookers" class="mec-options-fields">
                            <h4 class="mec-form-subtitle"><?php esc_html_e('Content only for bookers', 'mec'); ?></h4>
                            <div class="mec-form-row">
                                <div class="mec-col-12">
