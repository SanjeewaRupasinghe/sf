    ...
    public function item($args)
    {
        ...
        <div class="mec-box" id="mec_<?php echo esc_attr($id_prefix); ?>_row<?php echo esc_attr($i); ?>">
            ...
            <div class="mec-form-row">
                ...
                <button class="button" type="button" id="mec_remove_<?php echo esc_attr($id_prefix); ?>_button<?php echo esc_attr($i); ?>" onclick="mec_remove_ticket_variation(<?php echo esc_attr($i); ?>, '<?php echo esc_attr($id_prefix); ?>');"><?php esc_html_e('Remove', 'mec'); ?></button>
            </div>
        </div>
        <?php
    }
