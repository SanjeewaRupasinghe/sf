...
/**
 * Webnus MEC elementor search form grid view class
 *
 * @author Webnus <info@webnus.biz>
 */
class MEC_elementor_grid_search_form {

	/**
	 * Register Elementor search form grid options
	 *
	 * @author Webnus <info@webnus.biz>
	 */
	public static function options( $self ) {
		...
		$self->add_control(
			// mec_sk_options_
			'grid_address_search_placeholder',
			array(
