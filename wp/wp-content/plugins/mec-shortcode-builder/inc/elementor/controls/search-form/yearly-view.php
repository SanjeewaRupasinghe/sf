...
/**
 * Webnus MEC elementor search form yearly view class
 *
 * @author Webnus <info@webnus.biz>
 */
class MEC_elementor_yearly_search_form {

	/**
	 * Register Elementor search form yearly options
	 *
	 * @author Webnus <info@webnus.biz>
	 */
	public static function options( $self ) {
		...
		$self->add_control(
			// mec_sk_options_
			'yearly_address_search_placeholder',
			array(
		...
		$self->add_control(
			// mec_sk_options_
			'yearly_text_search_placeholder',
			array(
