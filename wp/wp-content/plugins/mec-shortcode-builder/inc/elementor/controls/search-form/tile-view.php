...
/**
 * Webnus MEC elementor search form tile view class
 *
 * @author Webnus <info@webnus.biz>
 */
class MEC_elementor_tile_search_form {

	/**
	 * Register Elementor search form tile options
	 *
	 * @author Webnus <info@webnus.biz>
	 */
	public static function options( $self ) {
		...
		$self->add_control(
			// mec_sk_options_
			'tile_address_search_placeholder',
			array(
