...
/**
 * Webnus MEC elementor search form daily view class
 *
 * @author Webnus <info@webnus.biz>
 */
class MEC_elementor_daily_search_form {

	/**
	 * Register Elementor search form daily options
	 *
	 * @author Webnus <info@webnus.biz>
	 */
	public static function options( $self ) {
		...
		$self->add_control(
			// mec_sk_options_
			'daily_address_search_placeholder',
			array(
