...
/**
 * Webnus MEC elementor search form custom view class
 *
 * @author Webnus <info@webnus.biz>
 */
class MEC_elementor_custom_search_form {

	/**
	 * Register Elementor search form custom options
	 *
	 * @author Webnus <info@webnus.biz>
	 */
	public static function options( $self ) {
		...
		$self->add_control(
			// mec_sk_options_
			'custom_address_search_placeholder',
			array(
		...
		$self->add_control(
			// mec_sk_options_
			'custom_text_search_placeholder',
			array(
