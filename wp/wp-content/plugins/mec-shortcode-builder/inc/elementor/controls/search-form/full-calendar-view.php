...
/**
 * Webnus MEC elementor search form full_calendar view class
 *
 * @author Webnus <info@webnus.biz>
 */
class MEC_elementor_full_calendar_search_form {

	/**
	 * Register Elementor search form full_calendar options
	 *
	 * @author Webnus <info@webnus.biz>
	 */
	public static function options( $self ) {
		...
		$self->add_control(
			// mec_sk_options_
			'full_calendar_sf_display_label',
			[
		...
		$self->add_control(
			// mec_sk_options_
			'full_calendar_address_search_type',
			array(
		...
		$self->add_control(
			// mec_sk_options_
			'full_calendar_address_search_placeholder',
			array(
		...
		$self->add_control(
			// mec_sk_options_
			'full_calendar_month_filter_type',
			array(
		...
		$self->add_control(
			// mec_sk_options_
			'full_calendar_time_filter_type',
			array(
		...
		$self->add_control(
			// mec_sk_options_
			'full_calendar_text_search_type',
			array(
		...
		$self->add_control(
			// mec_sk_options_
			'full_calendar_text_search_placeholder',
			array(
