...
/**
 * Webnus MEC elementor search form weekly view class
 *
 * @author Webnus <info@webnus.biz>
 */
class MEC_elementor_weekly_search_form {

	/**
	 * Register Elementor search form weekly options
	 *
	 * @author Webnus <info@webnus.biz>
	 */
	public static function options( $self ) {
		...
		$self->add_control(
			// mec_sk_options_
			'weekly_address_search_placeholder',
			array(
		...
		$self->add_control(
			// mec_sk_options_
			'weekly_text_search_placeholder',
			array(
