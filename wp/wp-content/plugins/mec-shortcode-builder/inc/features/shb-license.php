 ...
 */
class MEC_Shb_License extends MEC_base
{
    /**
     * The plugin current version
     */
    public $current_version = SHB_VERSION;
     ...
     * Plugin Slug
     */
    public $plugin_slug = SHB_BASENAME;
    ...
    public function check_info($false, $action, $arg)
    {
        if(isset($arg->slug) and $arg->slug === $this->slug)
        {
            ...
            if($information->item)
            {
                ...
                $arg->slug = $this->slug;
                $arg->plugin_name = 'Elementor Shortcode Builder for MEC';
                $arg->author = 'webnus';
