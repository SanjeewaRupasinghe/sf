...
class AddonLicense extends \MEC_base
{
     ...
     */
    public $current_version = MECSHORTCODEDESIGNERVERSION;
     ...
     * Plugin Slug
     */
    public $plugin_slug = MECSHORTCODEDESIGNERSLUG . '/mec-shortcode-designer.php';
    ...
    public function __construct()
    {
        ...
        // Plugin Slug
        $this->slug = MECSHORTCODEDESIGNERSLUG;
    ...
    public function check_info($false, $action, $arg)
    {
        if(isset($arg->slug) and $arg->slug === $this->slug)
        {
            ...
            if($information->item)
            {
                ...
                $arg->slug = $this->slug;
                $arg->plugin_name = MECSHORTCODEDESIGNERNAME;
                $arg->author = 'webnus';
