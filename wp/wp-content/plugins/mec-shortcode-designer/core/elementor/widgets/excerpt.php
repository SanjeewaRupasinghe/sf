 ...
 */
class MecShortCodeDesignerExcerpt extends Widget_Base {
	...
	public function get_title() {
		return __( 'MEC Excerpt', 'mec-shortcode-designer' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector'	=> '{{WRAPPER}} .mec-event-excerpt',
			]
		);
		$this->add_control(
			'title_align',
			[
				...
				'default' => 'left',
				'selectors' => [
					'{{WRAPPER}} .mec-event-excerpt' => 'text-align: {{VALUE}}',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .mec-event-excerpt' => 'display: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'	=> '#000',
				'selectors' => [
					'{{WRAPPER}} .mec-event-excerpt' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default'	=> '#000',
				'selectors' => [
					'{{WRAPPER}} .mec-event-excerpt:hover' => 'color: {{VALUE}}',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .mec-event-excerpt' => 'background: {{VALUE}}',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'default'	=> 'rgba(255,255,255,0)',
				'selectors' => [
					'{{WRAPPER}} .mec-event-excerpt:hover' => 'background: {{VALUE}}',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			[
				...
				'selectors'		=> [
					'{{WRAPPER}} .mec-event-excerpt' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'size_units'	=> [ 'px', '%', 'em' ],
				'selectors'		=> [
					'{{WRAPPER}} .mec-event-excerpt' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_group_control(
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .mec-event-excerpt' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_group_control(
