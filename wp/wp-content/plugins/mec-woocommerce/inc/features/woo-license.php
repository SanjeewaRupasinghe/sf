 ...
 */
class MEC_Woo_License extends MEC_base
{
    /**
     * The plugin current version
     */
    public $current_version = WOO_VERSION;
     ...
     * Plugin Slug
     */
    public $plugin_slug = WOO_BASENAME;
    ...
    public function check_info($false, $action, $arg)
    {
        if(isset($arg->slug) and $arg->slug === $this->slug)
        {
            ...
            if($information->item)
            {
                ...
                $arg->slug = $this->slug;
                $arg->plugin_name = 'WooCommerce Integration for MEC';
                $arg->author = 'webnus';
